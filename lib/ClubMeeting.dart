...
class _ClubMeetingState extends State<ClubMeeting> {
  ...
  void initState() {
    ...
    print("Todays date:" + Today.toString());
                                          ...
                                          children: <Widget>[
                                            ...
                                            if (snapshot.data[index]
                                                ...
                                                snapshot.data[index].meetingDate ==
                                                    Today && snapshot
                                                 .data[index].memberAttending!="Attending")
                                              Container(
                                                margin: EdgeInsets.only(
                                                    bottom: MediaQuery
                                                        .of(context)
                                                      ...
                                                      child: ElevatedButton(
                                                        ...
                                                        onPressed: () {
                                                          ...
                                                          String TotalLikes = snapshot
                                                              .data[index]
                                                              .totalLike;
                                                          String MemberLike=snapshot.data[index]
                                                              .memberLike;
                                                          print("MeetingDate:" +
                                                              MeetingDate!);
                                                          print("topic:" +
  ...
  setAttendace(String? date, String memberAttending, String meetingId,
    ...
    if ( meetingdate == Today  || meetingdate.isAfter(currentDate)  ) {
      return Row(
